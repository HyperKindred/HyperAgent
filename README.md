...
> **v0.2.1** — Phase 2.5 地基加固完成：156 个测试全通过，含时区统一/通知去重/记忆搜索优化/XSS 修复。免安装版在 [Releases](https://github.com/HyperKindred/HyperAgent/releases) 下载。
